		...
		<div class="header-template">
			...
			<div class="header-top">
				<div class="container">	
					...
					<div class="header-left"><?php hitsxyz_store_notices(); ?></div>
					
					<div class="header-right hidden-phone">
						<?php hitsxyz_top_header_menu(); ?>
				...
				<div class="header-middle">
					<div class="container">
						...
						<div class="header-left">
							...
							<div class="hits-sidebar-menu-icon">
						...
						<div class="header-center"><div class="logo-wrapper"><?php hitsxyz_theme_logo(); ?></div></div>
