		...
		<div class="header-template">
			...
			<div class="header-top">
				<div class="container">	
					...
					<div class="header-center"><?php hitsxyz_store_notices(); ?></div>
				...
				<div class="header-middle">
					<div class="container">
						...
						<div class="header-right">
							...
							<?php if( class_exists('YITH_WCWL') && $hitsxyz_theme_options['hits_enable_tiny_wishlist'] ): ?>
								<div class="my-wishlist-wrapper visible-phone"><?php echo hitsxyz_tini_wishlist(); ?></div>
							<?php endif; ?>
							
							<?php if( $hitsxyz_theme_options['hits_enable_tiny_shopping_cart'] ): ?>
							<div class="shopping-cart-wrapper visible-phone">
								<?php echo hitsxyz_tiny_cart(true, false); ?>
							</div>
							<?php endif; ?>
